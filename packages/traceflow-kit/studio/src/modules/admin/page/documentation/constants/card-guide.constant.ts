...
export const CARD_GUIDES: readonly CardGuide[] = [
  {
    ...
    placement: 'Aparece como una tarjeta propia debajo de HTTP dentro de la columna Entrada.',
    content: 'Nombre, método, duración, entrada, salida y accesos compactos a sus servicios directos, sin repetir sus operaciones internas.',
    interaction: 'Selecciona la tarjeta para inspeccionar el controller; los datos HTTP permanecen en la tarjeta superior.',
  },
  {
    type: 'http',
    ...
    interaction: 'Selecciona la tarjeta HTTP para inspeccionar la carga completa de la petición.',
  },
  {
    type: 'service',
    ...
    interaction: 'El nivel 1 muestra sus pasos principales. Usa “Expandir grupos” para revelar niveles 1.1, 1.1.1 y posteriores, o “Detalles” para inspeccionar el service.',
  },
  {
    type: 'method',
  ...
  },
  {
    ...
    content: 'Nombre de la regla, duración, estado y resúmenes de la entrada validada y su salida.',
    interaction: 'Selecciona la validación para abrir una tarjeta con el mismo patrón de entrada, salida y detalles que métodos y tablas.',
  },
  {
    type: 'transformation',
